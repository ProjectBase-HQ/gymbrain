...
const EXTRA_EXERCISES = [
  { id: "tmill", name: "Treadmill Run", sets: 1, reps: "30 min", rest: "—", equipment: ["machines"], muscle: "Cardio", muscleGroup: "cardio", type: "Cardio", difficulty: 2, tip: "Keep conversational pace for fat burn.", cue: "Breathe steady", equipmentLabel: "Treadmill" },
  { id: "bike", name: "Stationary Bike", sets: 1, reps: "20 min", rest: "—", equipment: ["machines"], muscle: "Cardio", muscleGroup: "cardio", type: "Cardio", difficulty: 1, tip: "Low-impact, great for active recovery post-lifting.", cue: "Keep RPM above 80", equipmentLabel: "Bike" },
...
const ALL_EXERCISES = {
  chest: [
    { id: "bp", name: "Flat Barbell Bench Press", sets: 4, reps: "6–8", rest: "2 min", equipment: ["barbell","plates"], muscle: "Pectoralis Major (Mid)", type: "Compound", difficulty: 3, tip: "Shoulder blades pinched, drive through legs. Bar path slightly diagonal.", cue: "Chest up, elbows 45°", equipmentLabel: "Barbell + Plates" },
    { id: "idp", name: "Incline Dumbbell Press", sets: 3, reps: "8–10", rest: "90s", equipment: ["dumbbells"], muscle: "Upper Chest", type: "Compound", difficulty: 2, tip: "30–45° incline. Lower slowly, pause at stretch.", cue: "Feel the stretch at bottom", equipmentLabel: "Dumbbells" },
    { id: "cf", name: "Cable Chest Fly", sets: 3, reps: "12–15", rest: "60s", equipment: ["cables"], muscle: "Chest (Stretch)", type: "Isolation", difficulty: 2, tip: "Fixed elbow bend throughout. Squeeze as if hugging a barrel.", cue: "Hug the barrel", equipmentLabel: "Cable Machine" },
    { id: "dips", name: "Weighted Dips", sets: 3, reps: "8–10", rest: "90s", equipment: ["bodyweight"], muscle: "Lower Chest + Triceps", type: "Compound", difficulty: 3, tip: "Lean torso forward 15–20° to bias chest.", cue: "Lean forward slightly", equipmentLabel: "Dip Bar" },
    { id: "dfp", name: "Decline Dumbbell Fly", sets: 3, reps: "12", rest: "60s", equipment: ["dumbbells"], muscle: "Lower Chest", type: "Isolation", difficulty: 2, tip: "Full stretch at bottom. Don't touch at top — keep tension.", cue: "Control the arc", equipmentLabel: "Dumbbells" },
    { id: "pu", name: "Push-Up Burnout", sets: 2, reps: "Max", rest: "60s", equipment: ["bodyweight"], muscle: "Full Chest", type: "Bodyweight", difficulty: 1, tip: "Chest to floor, fully lock out. Slow on the way down.", cue: "Slow negatives for max pump", equipmentLabel: "Bodyweight" },
    { id: "pec_deck", name: "Pec Deck Machine Fly", sets: 3, reps: "12–15", rest: "60s", equipment: ["machines"], muscle: "Chest (Contraction)", type: "Isolation", difficulty: 1, tip: "Elbows at shoulder height. Full squeeze at centre.", cue: "Squeeze at peak", equipmentLabel: "Pec Deck Machine" },
  ],
  back: [
    { id: "dl", name: "Conventional Deadlift", sets: 4, reps: "4–6", rest: "3 min", equipment: ["barbell","plates"], muscle: "Full Posterior Chain", type: "Compound", difficulty: 4, tip: "Bar over mid-foot, hinge at hips, neutral spine. Lock lats before pulling.", cue: "Push the floor away", equipmentLabel: "Barbell + Plates" },
    { id: "pup", name: "Pull-Ups", sets: 4, reps: "6–8", rest: "2 min", equipment: ["bodyweight"], muscle: "Lats + Biceps", type: "Compound", difficulty: 4, tip: "Depress scapula before pulling. Elbows drive down into pockets.", cue: "Elbows to hips", equipmentLabel: "Pull-Up Bar" },
    { id: "cr", name: "Seated Cable Row", sets: 3, reps: "10–12", rest: "75s", equipment: ["cables"], muscle: "Mid Back + Rhomboids", type: "Compound", difficulty: 2, tip: "Chest to pad. Row to lower chest. Pause and squeeze.", cue: "Chest proud, elbows tight", equipmentLabel: "Cable Machine" },
    { id: "dbr", name: "Single-Arm DB Row", sets: 3, reps: "10–12", rest: "60s", equipment: ["dumbbells"], muscle: "Lats + Rear Delt", type: "Compound", difficulty: 2, tip: "Full stretch at bottom, elbow drives up past hip.", cue: "Elbow to sky", equipmentLabel: "Dumbbell" },
    { id: "fp", name: "Face Pulls", sets: 3, reps: "15–20", rest: "60s", equipment: ["cables"], muscle: "Rear Delts + Rotator Cuff", type: "Isolation", difficulty: 1, tip: "Pull to forehead, rotate thumbs back at end range.", cue: "Double bicep at end", equipmentLabel: "Cable Machine" },
    { id: "lpd", name: "Lat Pulldown", sets: 3, reps: "10–12", rest: "75s", equipment: ["cables","machines"], muscle: "Lats (Width)", type: "Compound", difficulty: 2, tip: "Lean back slightly, pull to upper chest. Stretch arms at top.", cue: "Chest to bar", equipmentLabel: "Cable / Lat Machine" },
    { id: "bb_row", name: "Barbell Bent Over Row", sets: 4, reps: "6–8", rest: "2 min", equipment: ["barbell","plates"], muscle: "Mid Back + Lats", type: "Compound", difficulty: 3, tip: "Hinge 45°, bar to belly button. Overhand = rhomboids. Underhand = lats.", cue: "Bar to belly button", equipmentLabel: "Barbell + Plates" },
    { id: "kb_row", name: "Kettlebell Row", sets: 3, reps: "10/arm", rest: "60s", equipment: ["kettlebell"], muscle: "Lats + Mid Back", type: "Compound", difficulty: 2, tip: "Same mechanics as DB row. Neutral spine, full stretch.", cue: "Elbow to ceiling", equipmentLabel: "Kettlebell" },
  ],
  legs: [
    { id: "sq", name: "Barbell Back Squat", sets: 4, reps: "5–8", rest: "3 min", equipment: ["barbell","plates"], muscle: "Quads + Glutes + Hamstrings", type: "Compound", difficulty: 4, tip: "Break at hips and knees simultaneously. Knees track toes.", cue: "Spread the floor apart", equipmentLabel: "Barbell + Plates" },
    { id: "rdl", name: "Romanian Deadlift", sets: 3, reps: "8–10", rest: "2 min", equipment: ["barbell","dumbbells"], muscle: "Hamstrings + Glutes", type: "Compound", difficulty: 3, tip: "Soft knee bend, push hips back, bar drags down leg.", cue: "Hinge, don't squat", equipmentLabel: "Barbell or Dumbbells" },
    { id: "lp", name: "Leg Press", sets: 3, reps: "10–12", rest: "90s", equipment: ["machines"], muscle: "Quads + Glutes", type: "Compound", difficulty: 2, tip: "High foot = glutes. Low = quads. Never lock out knees.", cue: "Foot position matters", equipmentLabel: "Leg Press Machine" },
    { id: "lunge", name: "Bulgarian Split Squat", sets: 3, reps: "8–10/leg", rest: "90s", equipment: ["dumbbells","bodyweight"], muscle: "Quads + Glutes (Unilateral)", type: "Compound", difficulty: 3, tip: "Rear foot elevated. Torso slightly forward. Drive through front heel.", cue: "Hips drop straight down", equipmentLabel: "Dumbbells / Bodyweight" },
    { id: "lc", name: "Leg Curl Machine", sets: 3, reps: "12–15", rest: "60s", equipment: ["machines"], muscle: "Hamstrings (Isolated)", type: "Isolation", difficulty: 1, tip: "Foot slightly dorsiflexed. Pause at peak. Slow eccentric.", cue: "Point toes for more stretch", equipmentLabel: "Leg Curl Machine" },
    { id: "le", name: "Leg Extension", sets: 3, reps: "15", rest: "60s", equipment: ["machines"], muscle: "Quads (Isolated)", type: "Isolation", difficulty: 1, tip: "Lean back slightly. Full lock at top.", cue: "Squeeze at lockout", equipmentLabel: "Leg Extension Machine" },
    { id: "cr2", name: "Calf Raises", sets: 4, reps: "20–25", rest: "45s", equipment: ["machines","bodyweight"], muscle: "Gastrocnemius + Soleus", type: "Isolation", difficulty: 1, tip: "Full heel drop. Full rise. Pause 1s at top.", cue: "Full range always", equipmentLabel: "Machine or Bodyweight" },
    { id: "kb_goblet", name: "Goblet Squat", sets: 3, reps: "12", rest: "75s", equipment: ["kettlebell","dumbbells"], muscle: "Quads + Core", type: "Compound", difficulty: 2, tip: "Hold at chest. Chest tall, elbows track knees.", cue: "Chest up, knees out", equipmentLabel: "Kettlebell or Dumbbell" },
  ],
  glutes: [
    { id: "hbt", name: "Barbell Hip Thrust", sets: 4, reps: "8–12", rest: "90s", equipment: ["barbell","plates"], muscle: "Glutes (Primary)", type: "Compound", difficulty: 3, tip: "Bench at shoulder blades. Drive hips to ceiling, pelvic tilt at top.", cue: "Squeeze hard at top", equipmentLabel: "Barbell + Plates" },
    { id: "kbsw", name: "Kettlebell Swing", sets: 4, reps: "15–20", rest: "60s", equipment: ["kettlebell"], muscle: "Glutes + Hamstrings + Core", type: "Power", difficulty: 3, tip: "Hip hinge — not a squat. Snap hips forward explosively.", cue: "Hinge and snap", equipmentLabel: "Kettlebell" },
    { id: "ckg", name: "Cable Kickback", sets: 3, reps: "15/leg", rest: "45s", equipment: ["cables"], muscle: "Glutes (Isolation)", type: "Isolation", difficulty: 1, tip: "Flex at top, hold 1s. Slight forward lean.", cue: "Glute squeeze at extension", equipmentLabel: "Cable Machine" },
    { id: "sbss", name: "Sumo Deadlift", sets: 3, reps: "6–8", rest: "2 min", equipment: ["barbell","plates"], muscle: "Glutes + Inner Thighs", type: "Compound", difficulty: 3, tip: "Wide stance, toes out 45°. Pull the floor apart.", cue: "Push knees out", equipmentLabel: "Barbell + Plates" },
    { id: "gbr", name: "Glute Bridge (Banded)", sets: 3, reps: "15–20", rest: "60s", equipment: ["bodyweight"], muscle: "Glutes + Hamstrings", type: "Isolation", difficulty: 1, tip: "Band above knees, push knees out. 2s hold at top.", cue: "Push through heels", equipmentLabel: "Bodyweight" },
    { id: "dbell_hip", name: "Dumbbell Hip Thrust", sets: 4, reps: "10–12", rest: "75s", equipment: ["dumbbells"], muscle: "Glutes (Primary)", type: "Compound", difficulty: 2, tip: "Dumbbell on hip. Same mechanics as barbell version.", cue: "Drive hips to ceiling", equipmentLabel: "Dumbbell" },
  ],
  shoulders: [
    { id: "ohp", name: "Seated DB Overhead Press", sets: 4, reps: "8–10", rest: "90s", equipment: ["dumbbells"], muscle: "All 3 Delt Heads", type: "Compound", difficulty: 3, tip: "Neutral grip start. Press to lockout, slightly in front of ears.", cue: "Press up and slightly back", equipmentLabel: "Dumbbells" },
    { id: "lr", name: "Lateral Raises", sets: 4, reps: "15–20", rest: "60s", equipment: ["dumbbells","cables"], muscle: "Medial Delt", type: "Isolation", difficulty: 2, tip: "Lead with elbow. Thumb slightly down. Slight forward lean.", cue: "Pour the jug", equipmentLabel: "Dumbbells or Cables" },
    { id: "ap", name: "Arnold Press", sets: 3, reps: "10", rest: "75s", equipment: ["dumbbells"], muscle: "All Delts + Rotator Cuff", type: "Compound", difficulty: 3, tip: "Start palms facing you, rotate out as you press.", cue: "Rotate through the press", equipmentLabel: "Dumbbells" },
    { id: "upr", name: "Upright Row (Cable)", sets: 3, reps: "12", rest: "60s", equipment: ["cables","barbell"], muscle: "Medial Delt + Traps", type: "Compound", difficulty: 2, tip: "Wide grip, elbows lead above wrists. Never above ear.", cue: "Elbows above wrists", equipmentLabel: "Cable or Barbell" },
    { id: "rfp", name: "Rear Delt Fly", sets: 3, reps: "15", rest: "60s", equipment: ["dumbbells","cables"], muscle: "Rear Delt", type: "Isolation", difficulty: 2, tip: "Hinge to parallel. Slight bend in elbows. Lead elbows, not hands.", cue: "Elbows wide, not back", equipmentLabel: "Dumbbells or Cables" },
    { id: "bb_ohp", name: "Barbell Overhead Press", sets: 4, reps: "6–8", rest: "2 min", equipment: ["barbell","plates"], muscle: "Front + Medial Delt", type: "Compound", difficulty: 3, tip: "Bar at upper chest. Press straight up, head slightly back.", cue: "Push your head through", equipmentLabel: "Barbell + Plates" },
  ],
  biceps: [
    { id: "bbc", name: "Barbell Curl", sets: 4, reps: "8–10", rest: "75s", equipment: ["barbell","plates"], muscle: "Biceps (Full)", type: "Isolation", difficulty: 2, tip: "Full supination at top, full stretch at bottom. No swing.", cue: "Supinate at peak", equipmentLabel: "Barbell" },
    { id: "hc", name: "Incline Dumbbell Curl", sets: 3, reps: "10–12", rest: "60s", equipment: ["dumbbells"], muscle: "Biceps Long Head", type: "Isolation", difficulty: 2, tip: "Bench at 45–60°, arms hang back. Max stretch = max growth.", cue: "Let them stretch fully", equipmentLabel: "Dumbbells + Bench" },
    { id: "hamc", name: "Hammer Curl", sets: 3, reps: "12", rest: "60s", equipment: ["dumbbells"], muscle: "Brachialis + Brachioradialis", type: "Isolation", difficulty: 1, tip: "Neutral grip, alternating. Creates arm thickness.", cue: "Build arm thickness", equipmentLabel: "Dumbbells" },
    { id: "cc", name: "Cable Curl (Single Arm)", sets: 3, reps: "12–15", rest: "60s", equipment: ["cables"], muscle: "Biceps (Constant Tension)", type: "Isolation", difficulty: 1, tip: "Cable tension at full extension. Supinate at top.", cue: "Tension through full range", equipmentLabel: "Cable Machine" },
    { id: "pc", name: "Preacher Curl", sets: 3, reps: "10", rest: "75s", equipment: ["machines","barbell"], muscle: "Biceps Short Head", type: "Isolation", difficulty: 2, tip: "Slow eccentric, don't fully lock out.", cue: "Don't lock out", equipmentLabel: "Preacher Bench" },
    { id: "kb_curl", name: "Kettlebell Curl", sets: 3, reps: "12", rest: "60s", equipment: ["kettlebell"], muscle: "Biceps", type: "Isolation", difficulty: 1, tip: "Neutral grip. Offset weight challenges stabilisers.", cue: "Supinate at top", equipmentLabel: "Kettlebell" },
  ],
  triceps: [
    { id: "sc", name: "Skull Crushers (EZ Bar)", sets: 4, reps: "10", rest: "75s", equipment: ["barbell","plates"], muscle: "Triceps Long Head", type: "Isolation", difficulty: 3, tip: "Lower to forehead, elbows slightly back. Don't flare.", cue: "Elbows stay put", equipmentLabel: "EZ Bar / Barbell" },
    { id: "tpd", name: "Tricep Rope Pushdown", sets: 3, reps: "12–15", rest: "60s", equipment: ["cables"], muscle: "Triceps Lateral Head", type: "Isolation", difficulty: 1, tip: "Flare rope at bottom for full contraction. Elbows pinned.", cue: "Flare at bottom", equipmentLabel: "Cable + Rope" },
    { id: "cgb", name: "Close-Grip Bench Press", sets: 4, reps: "8–10", rest: "90s", equipment: ["barbell","plates"], muscle: "Triceps + Inner Chest", type: "Compound", difficulty: 3, tip: "Shoulder-width grip. Elbows 45° to torso.", cue: "Elbows at 45°", equipmentLabel: "Barbell + Plates" },
    { id: "ohte", name: "Overhead Tricep Extension", sets: 3, reps: "12", rest: "60s", equipment: ["dumbbells","cables"], muscle: "Triceps Long Head (Stretch)", type: "Isolation", difficulty: 2, tip: "Overhead stretches long head most. Control descent.", cue: "Maximize the stretch", equipmentLabel: "Dumbbell or Cable" },
    { id: "dkb", name: "Diamond Push-Up", sets: 3, reps: "Max", rest: "60s", equipment: ["bodyweight"], muscle: "Triceps + Inner Chest", type: "Bodyweight", difficulty: 2, tip: "Hands form diamond, elbows track straight back.", cue: "Track elbows back", equipmentLabel: "Bodyweight" },
    { id: "kb_tri", name: "Kettlebell Overhead Extension", sets: 3, reps: "12", rest: "60s", equipment: ["kettlebell"], muscle: "Triceps Long Head", type: "Isolation", difficulty: 2, tip: "Hold KB with both hands overhead. Lower behind head slowly.", cue: "Elbows close to ears", equipmentLabel: "Kettlebell" },
  ],
  core: [
    { id: "crc", name: "Cable Crunch", sets: 4, reps: "15–20", rest: "60s", equipment: ["cables"], muscle: "Upper Abs", type: "Isolation", difficulty: 2, tip: "Kneel, pull to knees. Crunch rib to hip.", cue: "Rib to hip, not head to knees", equipmentLabel: "Cable Machine" },
    { id: "hr", name: "Hanging Leg Raise", sets: 3, reps: "12–15", rest: "60s", equipment: ["bodyweight"], muscle: "Lower Abs + Hip Flexors", type: "Compound", difficulty: 3, tip: "Posterior pelvic tilt at top — curl tailbone up.", cue: "Curl the tailbone", equipmentLabel: "Pull-Up Bar" },
    { id: "pp", name: "Pallof Press", sets: 3, reps: "12/side", rest: "60s", equipment: ["cables"], muscle: "Anti-Rotation Core", type: "Anti-Rotation", difficulty: 2, tip: "Press out, hold 2s, return. Fight the rotation.", cue: "Don't twist", equipmentLabel: "Cable Machine" },
    { id: "awr", name: "Ab Wheel Rollout", sets: 3, reps: "10–12", rest: "75s", equipment: ["bodyweight"], muscle: "Full Core", type: "Compound", difficulty: 4, tip: "Hollow body position. Don't let hips sag.", cue: "Hollow body always", equipmentLabel: "Ab Wheel" },
    { id: "db_bug", name: "Dead Bug", sets: 3, reps: "10/side", rest: "60s", equipment: ["bodyweight"], muscle: "Deep Core Stabilisers", type: "Stability", difficulty: 2, tip: "Lower back flat throughout. Breathe out as you extend.", cue: "Back flat, always", equipmentLabel: "Bodyweight" },
    { id: "plnk", name: "RKC Plank", sets: 3, reps: "30–45s", rest: "45s", equipment: ["bodyweight"], muscle: "Full Core + Glutes", type: "Isometric", difficulty: 2, tip: "Squeeze everything — glutes, abs, elbows to toes.", cue: "Squeeze everything", equipmentLabel: "Bodyweight" },
    { id: "landmine_rot", name: "Landmine Rotations", sets: 3, reps: "12/side", rest: "60s", equipment: ["landmine","barbell"], muscle: "Obliques + Rotational Core", type: "Compound", difficulty: 3, tip: "Rotate from core — not arms. Powerful arc.", cue: "Rotate from hips", equipmentLabel: "Landmine + Barbell" },
  ],
};
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto", padding: "40px 20px 80px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 20 }}>
        {[{ label: "Total Sessions", val: history.length, icon: "🗓" }, { label: "This Week", val: `${weekSessions}/${user.freq}`, icon: "📅" }, { label: "Duration", val: `${user.duration}m`, icon: "⏱" }].map(s => (
            ...
            <div style={{ padding: "18px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                <div style={{ flex: 1, paddingRight: 10 }}>
                  <div style={{ fontSize: 15, fontWeight: 600, color: "#F0F0F0", marginBottom: 6 }}>{ex.name}</div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A0A0A", color: "#F0F0F0", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="fade-up">
        {screen === "loading" && <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", color: "#333" }}>Loading...</div>}
